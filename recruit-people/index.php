...
<body id="Recruit-People">
  ...
  <div id="AllBox">
    ...
    <main>
      ...
      <nav class="recruit_menu pc">
        <div class="container">
         <div class="content">
            <ul class="recruit_menu--list">
              <li class="recruit_menu--item">
                <a href="" class="recruit_menu--link">採用情報</a>
              </li>
              <li class="recruit_menu--item">
                <a href="" class="recruit_menu--link recruit_menu--link__active">人への想い</a>
              </li>
              <li class="recruit_menu--item">
                <a href="" class="recruit_menu--link">仕事案内</a>
              </li>
              <li class="recruit_menu--item">
                <a href="" class="recruit_menu--link">会社見学</a>
              </li>
              <li class="recruit_menu--item">
                <a href="" class="recruit_menu--link">募集要項</a>
              </li>
              <li class="recruit_menu--item">
                <a href="" class="recruit_menu--link">エントリーフォーム</a>
              </li>
            </ul>
            <ul class="recruit_menu--list">
              <li class="recruit_menu--item recruit_menu--item--lbl">
                <span class="recruit_menu--link recruit_menu--link--lbl">先輩インタビュー</span>
              </li>
              <li class="recruit_menu--item"> 
                <a href="" class="recruit_menu--link">2009年入社Oさん</a>
              </li>
              <li class="recruit_menu--item">
                <a href="" class="recruit_menu--link">2013年入社Hさん</a>
              </li>
              <li class="recruit_menu--item">
                <a href="" class="recruit_menu--link">2015年入社Nさん</a>
              </li>
              <li class="recruit_menu--item">
                <a href="" class="recruit_menu--link">2019年入社Aさん</a>
              </li>
            </ul>
         </div>
        </div>
